...
module.exports = {
    name: 'trivia',
    description: 'Starts a trivia game with the bot',
    usage: '+trivia',
    category: 'fun',
    /** 
     * @param {Client} client 
                ...
                { max: 1, time: 30000 }).then(collected => {
                    ...
                    if (this.input_answer == this.correct_answer) {
                        ...
                        this.question_message.edit(
                            ...
                            .setColor("BLURPLE")
                            .setDescription(`<:idle_correct:867340107699060756> Congratulation you got it correct!`)
                            .setTimestamp()
                        )
                        this.end_game()
                    }
                        ...
                        this.question_message.edit(
                            new discord.MessageEmbed()
                            .setColor("BLURPLE")
                            .setDescription(`<:idle_wrong:867305011137740840> Wrong Answer. The correct answer was ${this.reactions[this.correct_answer - 1]}`)
                            .setTimestamp()
                        )
                        this.end_game()
                    }
                    ...
                    this.question_message.edit(
                        new discord.MessageEmbed()
                        .setColor("BLURPLE")
                        .setDescription(`<:idle_wrong:867305011137740840> You have ran out of time. The correct answer was ${this.reactions[this.correct_answer - 1]}`)
                    )
                    this.end_game()
                })
            }
